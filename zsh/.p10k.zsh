# Generated by Powerlevel10k configuration wizard on 2020-02-08 at 21:28 PST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 06658.
...
() {
  ...
  typeset -ga POWERLEVEL9K_VIRTUALENV_GENERIC_NAMES=(virtualenv venv .venv env)
